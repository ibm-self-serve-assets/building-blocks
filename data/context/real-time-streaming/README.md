...
**IBM Products**: IBM Confluent
**Product Components**: Apache Kafka topics; Confluent Schema Registry; Apache Flink SQL (serverless); Confluent Connectors; Stream Governance; Confluent Hub; Terraform provider

## Overview

Stream, transform and govern continuously changing data using **IBM Confluent** on IBM Cloud. IBM Confluent is a fully managed Apache Kafka service that adds serverless Apache Flink stream processing, a large catalog of managed connectors, Stream Governance for schema management and data policies, and Confluent Hub. This building block enables real-time event ingestion, stateful stream transformations, enterprise schema governance, and infrastructure-as-code provisioning via Terraform.
