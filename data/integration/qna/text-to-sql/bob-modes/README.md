...
The custom Bob mode ([`base-modes/text-to-sql.zip`](base-modes/text-to-sql.zip)) defines the behavior, expertise, and capabilities of IBM Bob when working with Text-to-SQL tasks.
