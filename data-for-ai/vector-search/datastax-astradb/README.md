...
Cloud-native serverless vector database built on Apache Cassandra with global distribution.

## What's Included

### Assets

- Configuration and setup guides for Astra DB integration
  - Astra DB setup and configuration
  - Vector search implementation
  - Global distribution strategies
  - IBM Watsonx embeddings integration
