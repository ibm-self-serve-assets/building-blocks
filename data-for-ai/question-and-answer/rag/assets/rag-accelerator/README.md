...
Deployable API for RAG pipelines with document ingestion, embedding generation, and semantic search capabilities.
...
2. Change directory into `RAG-Accelerator`
    ...
    ```bash
    cd data-for-ai/question-and-answer/rag/assets/ingestion-retrieval
    ```
