# 🌐 IBM SevOne Network Monitoring & Observability
...
- [Overview](#overview)
- [Enterprise Architecture Creation](#1-enterprise-architecture-creation)
- [Demo Development Best Practices](#2-demo-development-best-practices)
- [Demo Recording & Asset Packaging](#3-demo-recording--asset-packaging)
- [Differentiation from Competitors](#4-differentiation-from-competitors)
- [Folder Structure](#5-folder-structure-for-code-development)
...
- [← Application Observability](../application-observability/README.md)
...
### Observe Building Blocks
- [Application Observability](../application-observability/README.md) - Monitor with IBM Instana
  - [Observability Dashboard](../application-observability/assets/application-observability/README.md)
  - [Bob Modes](../application-observability/bob-modes/README.md)

### Build & Deploy Building Blocks
- [Retail Application](../../build-and-deploy/Iaas/assets/retailapp/README.md) - Sample app
...
**[⬆ Back to Top](#-ibm-sevone-network-monitoring--observability)**
