...
📚 **[View Full Documentation](https://ibm-self-serve-assets.github.io/building-blocks-docs/ai-core/code-modernization/)**
...
Download the skill packages from the `assets/` directory:
- [`assets/code-modernization-expert.zip`](assets/code-modernization-expert.zip) - General code modernization
- [`assets/maximo-code-optimization.zip`](assets/maximo-code-optimization.zip) - Maximo script optimization
- [`assets/maximo-modernization-java.zip`](assets/maximo-modernization-java.zip) - Java/Maximo modernization

### Step 2: Extract Skills to Bob Workspace

Extract the contents from your project root into your Bob workspace skills directory:

```bash
# Navigate to your Bob workspace skills directory
cd /path/to/your/bob/workspace/.bob/skills

# Extract the skills from assets/
unzip /path/to/assets/code-modernization-expert.zip
unzip /path/to/assets/maximo-code-optimization.zip
unzip /path/to/assets/maximo-modernization-java.zip
```
...
#### AI Engineering
- [Agentic SDLC](../agentic-sdlc/) - AI-assisted development lifecycle
- [Headless Bob](../headless-bob/) - Server-side autonomous code generation
- [Integrate as Code](../integrate-as-code/) - Integration workflows and iPaaS
...
2. Review each skill's supporting documentation and pattern files
3. Ask Bob directly - the skills include comprehensive knowledge
4. Refer to official documentation for language/framework-specific questions
