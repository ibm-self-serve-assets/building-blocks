# 🚀 Step 1: Import Planning Analytics Custom Bob Mode (via Bob UI)

Before using IBM Bob with IBM Planning Analytics, you need to import the **Planning Analytics custom mode** into your project.
...
You can directly add the Planning Analytics mode.

### 📁 Add Mode Configuration

1. Download and extract `planning-analytics-mode.zip` file in base-modes folder.
...
1. Download and extract `planning-analytics-mode.zip` file.
2. Open `.bob/custom_modes.yaml` in the Bob UI editor.
3. Add the Planning Analytics mode at the end of the file.
...
# Add Planning Analytics mode
- slug: planning-analytics
...
- Confirm:
  ...
  - **Planning Analytics** mode appears
...
- Planning Analytics mode will be available in Bob UI.
- Existing modes will continue to function without disruption.
- You can start using the mode for **Budget and Forecasting** workflows with IBM Planning Analytics.
