# 🚀 Step 1: Import Application Risk & Continuous Compliance Custom Bob Mode (via Bob UI)

Before using IBM Bob with IBM Concert, you need to import the **Application Risk & Continuous Compliance custom mode** into your project.
...
You can directly add the Application Risk & Continuous Compliance mode.
...
4. Copy the content of the `.bob` folder extracted as part of Step 1:

```
.bob/
├── custom_modes.yaml
└── rules/
    └── application-risk-and-continuous-compliance/
        └── [mode rules files]
```
...
- Select **Application Risk & Continuous Compliance**
...
3. Add the Application Risk & Continuous Compliance mode at the end of the file.
...
# Add Application Risk & Continuous Compliance mode
- slug: application-risk-and-continuous-compliance
  name: Application Risk & Continuous Compliance
...
- Confirm:
  ...
  - **Application Risk & Continuous Compliance** mode appears
...
- Application Risk & Continuous Compliance mode will be available in Bob UI.
- Existing modes will continue to function without disruption.
- You can start using the mode for **Application Risk & Continuous Compliance** and IBM Concert resilience insights.
