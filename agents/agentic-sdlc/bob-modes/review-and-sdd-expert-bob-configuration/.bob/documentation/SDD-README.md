...
See [Real-World Examples](sdd-interactive-guide.md#real-world-examples) for:
...
- **Main SDD Mode**: [`spec-driven-development.md`](spec-driven-development.md)
...
- Review the [Interactive Guide](sdd-interactive-guide.md)
