...
> Note: package names on PyPI and internal IBM packages may differ. Use your organisation's dependency manager or the specific IBM distribution recommended for WatsonX/Watson OpenScale.
...
> Tip: Prefer setting secrets via environment variables or an external config file instead of editing the notebook directly.
