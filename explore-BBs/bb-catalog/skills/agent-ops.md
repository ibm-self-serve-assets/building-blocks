...
sources:
- location: block
  path: ai/ai-trust/agent-ops/bob-skills/agent-ops.zip
  layout: bob
- location: central
  path: ibm-bob/skills/agent-ops
  layout: dir
subskills: []
download: https://raw.githubusercontent.com/ibm-self-serve-assets/building-blocks/main/ai/ai-trust/agent-ops/bob-skills/agent-ops.zip
---
...
- `ai/ai-trust/agent-ops/bob-skills/agent-ops.zip` (block, layout: bob)
